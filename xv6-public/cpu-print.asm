...
_cpu-print:     file format elf32-i386
...

{
  ...
  20:	bb 80 96 98 00       	mov    $0x989680,%ebx
  ...
  32:	e8 c9 03 00 00       	call   400 <printf>
{
  ...
  3a:	83 eb 01             	sub    $0x1,%ebx
  3d:	75 e9                	jne    28 <main+0x28>
int main(int argc, char *argv[]) 

{
  ...
  int count = 0;
  while(count<10)
  3f:	83 ee 01             	sub    $0x1,%esi
  42:	75 dc                	jne    20 <main+0x20>
	{
	  printf(1,"sec, usec\n");
	}
      count++;
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 39f:	f7 f6                	div    %esi
 3a1:	0f b6 92 34 07 00 00 	movzbl 0x734(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 518:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 51b:	b8 2b 07 00 00       	mov    $0x72b,%eax
